...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected PIGGIE and zPIGGIE supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_piv))
            for denom in node['zPIGGIEsupply']:
                assert_equal(node['zPIGGIEsupply'][denom], DecimalAmt(expected_zpiv[denom]))
    ...
    def run_test(self):
        ...
        # Check PIGGIE and zPIGGIE supply at the beginning
        # ------------------------------------------
        # zPIGGIE supply: 2 coins for each denomination
        ...
        # PIGGIE supply: block rewards minus burned fees for minting
        ...
        # Verify that PIGGIE and zPIGGIE supplies were properly updated after the spends and reorgs
        self.log.info("Check PIGGIE and zPIGGIE supply...")
