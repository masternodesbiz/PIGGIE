...
"""Verify that starting PIGGIE with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start PIGGIE with -? for help text")
        ...
        self.log.info("Start PIGGIE with -version for version information")
