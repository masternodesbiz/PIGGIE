...
from fake_stake.base_test import piggie_FakeStakeTest

class zpiggiewrappedSerialsTest(piggie_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zpiggies..." % DENOM_TO_USE)
...
if __name__ == '__main__':
    zpiggiewrappedSerialsTest().main()
