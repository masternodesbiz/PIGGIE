...
RESOURCES += src/qt/piggie.qrc src/qt/piggie_locale.qrc

TRANSLATIONS += src/qt/locale/piggie_bg.ts \
                src/qt/locale/piggie_de.ts \
                src/qt/locale/piggie_en.ts \
                src/qt/locale/piggie_es.ts \
                src/qt/locale/piggie_fi.ts \
                src/qt/locale/piggie_fr.ts \
                src/qt/locale/piggie_it.ts \
                src/qt/locale/piggie_ja.ts \
                src/qt/locale/piggie_pl.ts \
                src/qt/locale/piggie_pt.ts \
                src/qt/locale/piggie_ru.ts \
                src/qt/locale/piggie_sk.ts \
                src/qt/locale/piggie_sv.ts \
                src/qt/locale/piggie_vi.ts \
                src/qt/locale/piggie_zh_CN.ts \
                src/qt/locale/piggie_zh_TW.ts
