...
#define MyAppName "PIGGIE Core"
#define MyAppPublisher "2021-2022 The PIGGIE Developers"
#define MyAppURL "https://github.com/masternodesguru/piggie/PIGGIE"
#define MyAppExeName "PIGGIE-qt.exe"
#define MyAppExtraData "https://github.com/masternodesguru/piggie/PIGGIE/releases/download/v2.0/bootstrap.zip"
...
OutputDir=.\output
OutputBaseFilename=PIGGIESetup
...
[Files]
Source: ".\package\PIGGIE-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\PIGGIE\PIGGIE-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\PIGGIE\PIGGIE-Qt,strDataDir|{userappdata}\PIGGIE\}');
  Result := True;
end;
