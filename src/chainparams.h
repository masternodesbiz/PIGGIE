 ...
 * piggie system. There are three: the main network on which people trade goods
...
public:
    ...
    int piggieBadBlockTime() const { return npiggieBadBlockTime; }
    int piggieBadBlocknBits() const { return npiggieBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t npiggieBadBlockTime;
    unsigned int npiggieBadBlocknBits;
