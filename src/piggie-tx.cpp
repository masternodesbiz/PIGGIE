...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("piggie Coin piggie-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  piggie-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded piggie transaction") + "\n" +
                               "  piggie-tx [options] -create [commands]   " + _("Create hex-encoded piggie transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded piggie transaction
