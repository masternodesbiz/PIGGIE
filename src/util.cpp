...
const char * const PIVX_CONF_FILENAME = "PIGGIE.conf";
const char * const PIVX_PID_FILENAME = "PIGGIE.pid";
const char * const PIVX_MASTERNODE_CONF_FILENAME = "masternode.conf";
const char * const PIVX_ACTIVE_MASTERNODE_CONF_FILENAME = "activemasternode.conf";


// PIGGIE only features
// Masternode
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\PIGGIE
// Windows >= Vista: C:\Users\Username\AppData\Roaming\PIGGIE
// Mac: ~/Library/Application Support/PIGGIE
// Unix: ~/.PIGGIE
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "PIGGIE";
#else
    fs::path pathRet;
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty PIGGIE.conf if it does not exist
        ...
        if (configFile != NULL) {
	        ...
	        strHeader += "\nrpcport=38164\naddnode=seed1.masternodes.guru/piggie:38165\naddnode=seed2.masternodes.guru/piggie:38165\naddnode=seed3.masternodes.guru/piggie:38165\naddnode=seed4.masternodes.guru/piggie:38165\naddnode=seed5.masternodes.guru/piggie:38165\naddnode=seed6.masternodes.guru/piggie:38165\naddnode=seed7.masternodes.guru/piggie:38165\naddnode=seed8.masternodes.guru/piggie:38165\n";
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override PIGGIE.conf
