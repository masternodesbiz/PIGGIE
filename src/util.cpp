...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "piggie" is a composite category enabling all piggie-related debug output
            if (ptrCategory->count(std::string("piggie"))) {
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "piggie.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "piggied.pid"));
