...
#ifndef piggie_INVALID_SERIALS_JSON_H
#define piggie_INVALID_SERIALS_JSON_H
...
std::string LoadInvalidSerials()
{
    std::string str = "[\n"
            ...
            "  },\n"
            "  {\n"
            "    \"s\": \"c90233f1164b6b7628c9cea9affc2fd0937302e78806054cf0549c22190383dd\"\n"
            "  },\n"
            "  {\n"
...
#endif //piggie_INVALID_SERIALS_JSON_H
