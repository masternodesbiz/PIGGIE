...
/** Utility functions used by the piggie Qt UI.
 */
namespace GUIUtil
{
...
// Render piggie addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool iszpiggie = false);
...
// Parse "piggie:" URI into recipient object, return true on successful parsing
