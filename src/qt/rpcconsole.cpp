                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzpiggiePathCustom = GetArg("-zpiggiebackuppath", "");
    ...
    if(!strzpiggiePathCustom.empty()) {
        ui->wallet_customzpiggiebackuppath->setText(QString::fromStdString(strzpiggiePathCustom));
        ui->wallet_customzpiggiebackuppath_label->setVisible(true);
        ui->wallet_customzpiggiebackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzpiggiePathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the piggie RPC console.") + "<br>" +
