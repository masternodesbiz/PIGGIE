...
#include "qt/piggie/settings/settingsnetworkwidget.h"
#include "qt/piggie/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/piggie/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(piggieGUI* _window, QWidget *parent) :
