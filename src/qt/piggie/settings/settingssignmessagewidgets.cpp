...
#include "qt/piggie/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(piggieGUI* _window, QWidget *parent) :
