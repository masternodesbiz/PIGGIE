...
#include "qt/piggie/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/piggie/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(piggieGUI* _window, QWidget *parent) :
