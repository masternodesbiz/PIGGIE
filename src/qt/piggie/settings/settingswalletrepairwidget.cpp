...
#include "qt/piggie/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/piggie/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(piggieGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to piggieGUI::handleRestart()
