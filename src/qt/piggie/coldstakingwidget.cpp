...
#include "qt/piggie/coldstakingwidget.h"
#include "qt/piggie/forms/ui_coldstakingwidget.h"
#include "qt/piggie/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/piggie/requestdialog.h"
#include "qt/piggie/tooltipmenu.h"
#include "qt/piggie/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(piggieGUI* parent) :
    PWidget(parent),
    ui(new Ui::ColdStakingWidget)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your piggies and let a hot node (24/7 online node)\nstake in your behalf, keeping the keys in a secure place offline."));
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept piggie delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select piggie outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 piggie" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
