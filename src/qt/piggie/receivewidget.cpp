...
#include "qt/piggie/forms/ui_receivewidget.h"
...
#include "qt/piggie/addressholder.h"
...
ReceiveWidget::ReceiveWidget(piggieGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive piggie."));
