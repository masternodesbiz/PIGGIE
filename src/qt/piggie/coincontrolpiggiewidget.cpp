...
#include "qt/piggie/coincontrolpiggiewidget.h"
#include "qt/piggie/forms/ui_coincontrolpiggiewidget.h"

CoinControlpiggieWidget::CoinControlpiggieWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlpiggieWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select piggie Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("piggie");
    ...
    ui->labelValueAfter->setText("0.00 piggie");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 piggie");
    ui->labelValueFee->setText("0.00 piggie");
...
CoinControlpiggieWidget::~CoinControlpiggieWidget()
{
    delete ui;
}
