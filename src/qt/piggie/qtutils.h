...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, piggieGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, piggieGUI *gui, double posX = 3);
