...
#include "qt/piggie/furabstractlistitemdelegate.h"
...
#include "config/piggie-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qreal maxValue = 0;
    qint64 totalpiggie = 0;
    qint64 totalzpiggie = 0;
    QList<qreal> valuespiggie;
    QList<qreal> valueszpiggie;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(piggieGUI* _window);
    ~DashboardWidget();
