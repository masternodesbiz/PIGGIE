...
#ifndef piggie_zpiggieTRACKER_H
#define piggie_zpiggieTRACKER_H
...
public:
    CzpiggieTracker(std::string strWalletFile);
    ~CzpiggieTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzpiggieWallet* zpiggieWallet = NULL);
