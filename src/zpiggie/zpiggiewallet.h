// Copyright (c) 2017-2018 The piggie developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef piggie_zpiggieWALLET_H
#define piggie_zpiggieWALLET_H
...
public:
    CzpiggieWallet(std::string strWalletFile);
    ...
    void GenerateDeterministiczpiggie(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedTozpiggie(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
