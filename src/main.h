...
/** zpiggie precomputing variables
...
inline int64_t GetMasterNodeCollateral(int nHeight){
    if (nHeight <= 250 && nHeight > 0) {
        return 5000;
    } else if (nHeight <= 60000 && nHeight > 250) {
        return 5000;
    } else if (nHeight <= 220000 && nHeight > 60001) {
        return 10000;
    } else if (nHeight <= 400000 && nHeight > 220001) {
        return 25000;
    } else if (nHeight <= 800000 && nHeight > 400001) {
        return 50000;
    } else if (nHeight <= 1000000 && nHeight > 800001) {
        return 75000;
    } else if (nHeight <= 5000000 && nHeight > 1000001) {
        return 100000;
