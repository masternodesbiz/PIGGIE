...
extern UniValue DozpiggieSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzpiggieseed(const UniValue& params, bool fHelp);
extern UniValue getzpiggieseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzpiggie(const UniValue& params, bool fHelp);
extern UniValue dzpiggiestate(const UniValue& params, bool fHelp);
