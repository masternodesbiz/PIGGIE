...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PIGGIE features */
        {"PIGGIE", "listmasternodes", &listmasternodes, true },
        {"PIGGIE", "getmasternodecount", &getmasternodecount, true },
        {"PIGGIE", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"PIGGIE", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"PIGGIE", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"PIGGIE", "masternodecurrent", &masternodecurrent, true },
        {"PIGGIE", "startmasternode", &startmasternode, true },
        {"PIGGIE", "createmasternodekey", &createmasternodekey, true },
        {"PIGGIE", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"PIGGIE", "listmasternodeconf", &listmasternodeconf, true },
        {"PIGGIE", "getmasternodestatus", &getmasternodestatus, true },
        {"PIGGIE", "getmasternodewinners", &getmasternodewinners, true },
        {"PIGGIE", "getmasternodescores", &getmasternodescores, true },
        {"PIGGIE", "mnsync", &mnsync, true },
        {"PIGGIE", "spork", &spork, true },
        {"PIGGIE", "getcollateral", &getcollateral, true},
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:38164/\n";
}
