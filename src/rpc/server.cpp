...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* piggie features */
        {"piggie", "listmasternodes", &listmasternodes, true, true, false},
        {"piggie", "getmasternodecount", &getmasternodecount, true, true, false},
        {"piggie", "masternodeconnect", &masternodeconnect, true, true, false},
        {"piggie", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"piggie", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"piggie", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"piggie", "masternodecurrent", &masternodecurrent, true, true, false},
        {"piggie", "masternodedebug", &masternodedebug, true, true, false},
        {"piggie", "startmasternode", &startmasternode, true, true, false},
        {"piggie", "createmasternodekey", &createmasternodekey, true, true, false},
        {"piggie", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"piggie", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"piggie", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"piggie", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"piggie", "getmasternodescores", &getmasternodescores, true, true, false},
        {"piggie", "preparebudget", &preparebudget, true, true, false},
        {"piggie", "submitbudget", &submitbudget, true, true, false},
        {"piggie", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"piggie", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"piggie", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"piggie", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"piggie", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"piggie", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"piggie", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"piggie", "checkbudgets", &checkbudgets, true, true, false},
        {"piggie", "mnsync", &mnsync, true, true, false},
        {"piggie", "spork", &spork, true, true, false},
        {"piggie", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> piggie-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22189/\n";
}
